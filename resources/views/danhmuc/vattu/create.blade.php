            ...
            <div class="modal-body ">
                ...
                <form action="#" id="form-create">
                    ...
                    <div class="form-group row" hidden>
                        ...
                        <input type="number" class="col-md-6 form-control" id="c-sup_amount" min="0" value="0" />
                    </div>

                    <div class="form-group row">
                        <label class="col-md-4 text-md-right font-weight-bold">Đơn Vị Tính</label>
                        <select class="col-md-6 form-control" name="c-unit_id" id="c-unit_id" class="form-control"
                            required>
